...
public struct Color
{
	...
	//presets
	public static readonly Color Wallfg = new Color("#ffffff");
	public static readonly Color Wallbg = new Color("#551e2c");
	...
	public static readonly Color Cyan = new Color("#00cfcf");
	public static readonly Color Red = new Color("#f10e0e");
	public static readonly Color Purple = new Color("#880ce0");
